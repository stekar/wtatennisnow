...
/**
 * Created by stekar on 1/18/15.
 */
public class AsyncATPScheduleUpdateEventFlag extends AsyncTask<ATPSchedule, Void, Boolean> {
    @Override
    protected Boolean doInBackground(ATPSchedule... scheduleItems) {
        ...
        if(scheduleItems != null) {
            ...
            isRowsUpdated = AppSqlHelper.getInstance(AppController.getInstance().getAppContext()).getATPTournasHelper().updateTournaItemEventFlag(scheduleItem,
